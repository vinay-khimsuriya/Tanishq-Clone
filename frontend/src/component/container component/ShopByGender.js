...
import StaticImageComponentForShopByGender from "../../comman component/StaticImageComponentForShopByGender";
  ...
  return (
    <div className="w-full rounded-md pb-10">
      ...
      <div className="w-full flex gap-0 flex-wrap lg:flex-nowrap lg:gap-4 lg:py-3 hover:cursor-pointer rounded-md">
        <div className="w-full sm:w-1/2 lg:w-1/3 shadow-sm shadow-black rounded-md mt-3 mb-2 lg:my-2 ">
          <StaticImageComponentForShopByGender imagePath={men} name="Men" />
        </div>
        <div className="w-full sm:w-1/2 lg:w-1/3 shadow-sm shadow-black rounded-md mt-3 mb-2 lg:my-2">
          <StaticImageComponentForShopByGender imagePath={kid} name="Kids" />
        </div>
        <div className="w-full lg:w-1/3 shadow-sm shadow-black rounded-md mt-2 mb-3 lg:my-2">
          <StaticImageComponentForShopByGender imagePath={woman} name="Woman" />
        </div>
      </div>
    </div>
  );
