    ...
    <div className="w-72 py-4 border border-slate-300 rounded-md text-[#963b3b] absolute top-[101%] -lg:right-36 -right-28  bg-white">
      <div className="">
        ...
        <div className="flex px-2 justify-evenly my-3">
          <button className="pb-[0.05rem] px-[0.75rem] border border-[#dfc3c3] rounded-md">
            Login
          </button>
          <button className=" pb-[0.05rem] px-[0.75rem] border border-white rounded-md text-white bg-[#b44343]">
            Sign Up
          </button>
        </div>
